...
<s:url var="shipmentURL" value="/checkout/shipment" />
<script type="text/javascript">
	function amountChanged() {
		...
		var shipmentCost = parseFloat($("#shipmentInput").html());
...
<div>
	...
	<table>
		<tr>
			...
			<td class="ptd"><input type="button" value="Calculate" id="calcShipment">
			</td>
		</tr>
		<tr>
			<td class="ptd">
				<div class="pinfo" style="text-decoration: underline;">
					Shipment Cost:</div>
			</td>
			<td class="ptd"><div class="pinfo" id="shipmentInput">${shipmentCost}</div></td>
		</tr>
...
$("#calcShipment").click(function() {
	alert("ewwww");
	var selectedCountry = {country:"germany"};;
	$.ajax({
		url : "${shipmentURL}",
		type : "POST",
