 ...
 */
            ...
            /**
            *  CheckStatusOfDelivery bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CheckStatusOfDelivery
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":checkStatusOfDelivery",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "checkStatusOfDelivery",
    ...
    public static class Factory{
        ...
        */
        public static CheckStatusOfDelivery parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CheckStatusOfDelivery object =
                new CheckStatusOfDelivery();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"checkStatusOfDelivery".equals(type)){
                                ...
                                return (CheckStatusOfDelivery)gr.uoc.imse.transportationb.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
