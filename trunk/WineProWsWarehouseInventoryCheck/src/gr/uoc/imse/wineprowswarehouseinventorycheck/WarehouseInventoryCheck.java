/**
 * WarehouseInventoryCheck.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.6.2 Built on : Apr 17, 2012 (05:34:40
 * IST)
 */
...
/**
 * WarehouseInventoryCheck bean class
 */
@SuppressWarnings ( { "unchecked", "unused" } )
public class WarehouseInventoryCheck implements org.apache.axis2.databinding.ADBBean
{

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
		"http://imse.uoc.gr/WineProWsWarehouseInventoryCheck/", "warehouseInventoryCheck", "ns2" );

	/**
	 * field for WineQuantityPairs
	 */

	protected gr.uoc.imse.wineprowswarehouseinventorycheck.WineQuantityPairType localWineQuantityPairs;

	/**
	 * Auto generated getter method
	 * 
	 * @return gr.uoc.imse.wineprowswarehouseinventorycheck.WineQuantityPairType
	 */
	public gr.uoc.imse.wineprowswarehouseinventorycheck.WineQuantityPairType getWineQuantityPairs ()
	{
	 ...
	 *        WineQuantityPairs
	 */
	public void setWineQuantityPairs ( gr.uoc.imse.wineprowswarehouseinventorycheck.WineQuantityPairType param )
	{
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if ( serializeType )
		{
			...
			{
				writeAttribute( "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":warehouseInventoryCheck",
					xmlWriter );
			}
			else
			{
		...
		localWineQuantityPairs.serialize( new javax.xml.namespace.QName( "", "wineQuantityPairs" ), xmlWriter );
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		elementList.add( new javax.xml.namespace.QName( "", "wineQuantityPairs" ) );
	...
	public static class Factory
	{
		...
		public static WarehouseInventoryCheck parse ( javax.xml.stream.XMLStreamReader reader ) throws java.lang.Exception
		{
			...
			try
			{
				...
				if ( reader.getAttributeValue( "http://www.w3.org/2001/XMLSchema-instance", "type" ) != null )
				{
					...
					if ( fullTypeName != null )
					{
						...
						if ( !"warehouseInventoryCheck".equals( type ) )
						{
							...
							return (WarehouseInventoryCheck) gr.uoc.imse.wineprowswarehouseinventorycheck.ExtensionMapper.getTypeObject(
								nsUri, type, reader );
						}
				...
				if ( reader.isStartElement() && new javax.xml.namespace.QName( "", "wineQuantityPairs" ).equals( reader.getName() ) )
				{

					object.setWineQuantityPairs( gr.uoc.imse.wineprowswarehouseinventorycheck.WineQuantityPairType.Factory.parse( reader ) );
