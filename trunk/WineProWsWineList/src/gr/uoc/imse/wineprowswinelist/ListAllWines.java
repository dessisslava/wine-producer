/**
 * ListAllWines.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.6.2 Built on : Apr 17, 2012 (05:34:40 IST)
 */

package gr.uoc.imse.wineprowswinelist;

/**
 * ListAllWines bean class
 */
@SuppressWarnings ( { "unchecked", "unused" } )
public class ListAllWines implements org.apache.axis2.databinding.ADBBean
{
			...
			throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException
	{
		...
		if ( serializeType )
		{
			...
			{
				writeAttribute( "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":listAllWines", xmlWriter );
			}
			else
			{
				...
				if ( reader.getAttributeValue( "http://www.w3.org/2001/XMLSchema-instance", "type" ) != null )
				{
					...
					if ( fullTypeName != null )
					{
						...
						if ( !"listAllWines".equals( type ) )
						{
							...
							return (ListAllWines) gr.uoc.imse.wineprowswinelist.ExtensionMapper.getTypeObject( nsUri, type, reader );
						}
