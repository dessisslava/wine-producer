...
/**
 * GrapesProducerNorthMessageReceiverInOut.java
 *
 ...
 */
        ...
        /**
        *  GrapesProducerNorthMessageReceiverInOut message receiver
        */

        public class GrapesProducerNorthMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        GrapesProducerNorthSkeleton skel = (GrapesProducerNorthSkeleton)obj;
        //Out Envelop
                ...
                uoc.imse.winepro.www.grapesproducer.CancelOrderResponseElement cancelOrderResponseElement1 = null;
	                        uoc.imse.winepro.www.grapesproducer.CancelOrderRequestElement wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), cancelOrderResponseElement1, false, new javax.xml.namespace.QName("http://www.winepro.imse.uoc/GrapesProducerNorth/",
                                                    "cancelOrder"));
                                    } else 

            if("placeOrder".equals(methodName)){
                
                uoc.imse.winepro.www.grapesproducer.PlaceOrderResponseElement placeOrderResponseElement3 = null;
	                        uoc.imse.winepro.www.grapesproducer.PlaceOrderRequestElement wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               placeOrderResponseElement3 =
                                                   
                                                   
                                                         skel.placeOrder(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), placeOrderResponseElement3, false, new javax.xml.namespace.QName("http://www.winepro.imse.uoc/GrapesProducerNorth/",
                                                    "placeOrder"));
                                    } else 

            if("getOrderStatus".equals(methodName)){
                
                uoc.imse.winepro.www.grapesproducer.GetOrderStatusResponseElement getOrderStatusResponseElement5 = null;
	                        uoc.imse.winepro.www.grapesproducer.GetOrderStatusRequestElement wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               getOrderStatusResponseElement5 =
                                                   
                                                   
                                                         skel.getOrderStatus(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getOrderStatusResponseElement5, false, new javax.xml.namespace.QName("http://www.winepro.imse.uoc/GrapesProducerNorth/",
                                                    "getOrderStatus"));
                                    } else 

            if("checkAvailability".equals(methodName)){
                
                uoc.imse.winepro.www.grapesproducer.CheckAvailabilityResponseElement checkAvailabilityResponseElement7 = null;
	                        uoc.imse.winepro.www.grapesproducer.CheckAvailabilityRequestElement wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               checkAvailabilityResponseElement7 =
                                                   
                                                   
                                                         skel.checkAvailability(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), checkAvailabilityResponseElement7, false, new javax.xml.namespace.QName("http://www.winepro.imse.uoc/GrapesProducerNorth/",
                                                    "checkAvailability"));
                                    } else 

            if("listGrapes".equals(methodName)){
                
                uoc.imse.winepro.www.grapesproducer.ListGrapesResponseElement listGrapesResponseElement9 = null;
	                        uoc.imse.winepro.www.grapesproducer.ListGrapesRequestElement wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                               ...
                                               listGrapesResponseElement9 =
                                                   
                                                   
                                                         skel.listGrapes(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), listGrapesResponseElement9, false, new javax.xml.namespace.QName("http://www.winepro.imse.uoc/GrapesProducerNorth/",
                                                    "listGrapes"));
