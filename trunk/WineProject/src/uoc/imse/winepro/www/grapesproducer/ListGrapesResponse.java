 ...
 */
            ...
            /**
            *  ListGrapesResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ListGrapesResponse
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = listGrapesResponse
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for Quantity_Available
                        */

                        
                                    protected java.lang.String localQuantity_Available ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getQuantity_Available(){
                               return localQuantity_Available;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Quantity_Available
                               */
                               public void setQuantity_Available(java.lang.String param){
                            
                                            this.localQuantity_Available=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":listGrapesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "listGrapesResponse",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://www.winepro.imse.uoc/GrapesProducer";
                                    writeStartElement(null, namespace, "Quantity_Available", xmlWriter);
                             

                                          if (localQuantity_Available==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("Quantity_Available cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localQuantity_Available);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.winepro.imse.uoc/GrapesProducer",
                                        ...
                                        if (localQuantity_Available != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQuantity_Available));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("Quantity_Available cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static ListGrapesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListGrapesResponse object =
                new ListGrapesResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listGrapesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ListGrapesResponse)uoc.imse.winepro.www.grapesproducernorth.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.winepro.imse.uoc/GrapesProducer","Quantity_Available").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"Quantity_Available" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setQuantity_Available(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
