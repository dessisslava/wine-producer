    ...
    public class GrapesProducerSouthSkeleton{
         ...
         */
                  ...
                  ) throws ParseException
            {
                    ...
                    cal.setTime(new Date()); // sets calendar time/date
                	 ...
                	 quantity_available= Double.parseDouble(MySQL_connection_South.checkAvailability(grapes_variety, delivery_address)[0]);
                	 Integer delivery_time = Integer.parseInt(MySQL_connection_South.checkAvailability(grapes_variety, delivery_address)[2]);
         ...
         */
                  ...
                  )
            {
                	 ...
                	 double quantity_available= Double.parseDouble(MySQL_connection_South.checkAvailability(grapes_variety, delivery_address)[0]);
                	 double price = Double.parseDouble(MySQL_connection_South.checkAvailability(grapes_variety, delivery_address)[1]);
                	 Integer delivery_time = Integer.parseInt(MySQL_connection_South.checkAvailability(grapes_variety, delivery_address)[2]);
