 ...
 */
            ...
            /**
            *  DeliverGrapesResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeliverGrapesResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":deliverGrapesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "deliverGrapesResponse",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static DeliverGrapesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeliverGrapesResponse object =
                new DeliverGrapesResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"deliverGrapesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeliverGrapesResponse)uoc.imse.winepro.www.transportation.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.winepro.imse.uoc/Transportation_Schema","Confirmation").equals(reader.getName())){
