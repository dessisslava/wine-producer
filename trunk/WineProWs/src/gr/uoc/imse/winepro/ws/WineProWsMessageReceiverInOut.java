 ...
 */
        ...
        */
            ...
            if("listAllWinesInBetween".equals(methodName)){
                ...
                gr.uoc.imse.wineprows.ListAllWinesInBetweenResponse listAllWinesInBetweenResponse3 = null;
	                        gr.uoc.imse.wineprows.ListAllWinesInBetween wrappedParam =
                                                             (gr.uoc.imse.wineprows.ListAllWinesInBetween)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    gr.uoc.imse.wineprows.ListAllWinesInBetween.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), listAllWinesInBetweenResponse3, false, new javax.xml.namespace.QName("http://imse.uoc.gr/WineProWs/",
            ...
            if("warehouseInventoryCheck".equals(methodName)){
                ...
                gr.uoc.imse.wineprows.WarehouseInventoryCheckResponse warehouseInventoryCheckResponse5 = null;
	                        gr.uoc.imse.wineprows.WarehouseInventoryCheck wrappedParam =
                                                             (gr.uoc.imse.wineprows.WarehouseInventoryCheck)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    gr.uoc.imse.wineprows.WarehouseInventoryCheck.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), warehouseInventoryCheckResponse5, false, new javax.xml.namespace.QName("http://imse.uoc.gr/WineProWs/",
                                                    "warehouseInventoryCheck"));
                                    } else 

            if("getTotalWeightVolume".equals(methodName)){
                
                gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse getTotalWeightVolumeResponse7 = null;
	                        gr.uoc.imse.wineprows.GetTotalWeightVolume wrappedParam =
                                                             (gr.uoc.imse.wineprows.GetTotalWeightVolume)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    gr.uoc.imse.wineprows.GetTotalWeightVolume.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               getTotalWeightVolumeResponse7 =
                                                   
                                                   
                                                         skel.getTotalWeightVolume(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getTotalWeightVolumeResponse7, false, new javax.xml.namespace.QName("http://imse.uoc.gr/WineProWs/",
                                                    "getTotalWeightVolume"));
                                    } else 

            if("warehouseInventoryReserve".equals(methodName)){
                
                gr.uoc.imse.wineprows.WarehouseInventoryReserveResponse warehouseInventoryReserveResponse9 = null;
	                        gr.uoc.imse.wineprows.WarehouseInventoryReserve wrappedParam =
                                                             (gr.uoc.imse.wineprows.WarehouseInventoryReserve)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    gr.uoc.imse.wineprows.WarehouseInventoryReserve.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               warehouseInventoryReserveResponse9 =
                                                   
                                                   
                                                         skel.warehouseInventoryReserve(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), warehouseInventoryReserveResponse9, false, new javax.xml.namespace.QName("http://imse.uoc.gr/WineProWs/",
                                                    "warehouseInventoryReserve"));
                                    } else 

            if("getTotalPriceOfGoods".equals(methodName)){
                
                gr.uoc.imse.wineprows.GetTotalPriceOfGoodsResponse getTotalPriceOfGoodsResponse11 = null;
	                        gr.uoc.imse.wineprows.GetTotalPriceOfGoods wrappedParam =
                                                             (gr.uoc.imse.wineprows.GetTotalPriceOfGoods)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    gr.uoc.imse.wineprows.GetTotalPriceOfGoods.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                                
                                               getTotalPriceOfGoodsResponse11 =
                                                   
                                                   
                                                         skel.getTotalPriceOfGoods(wrappedParam)
                                                    ;
                                            
                                        envelope = toEnvelope(getSOAPFactory(msgContext), getTotalPriceOfGoodsResponse11, false, new javax.xml.namespace.QName("http://imse.uoc.gr/WineProWs/",
        ...
        //
            ...
            private  org.apache.axiom.om.OMElement  toOM(gr.uoc.imse.wineprows.GetTotalWeightVolume param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(gr.uoc.imse.wineprows.GetTotalWeightVolume.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            throws org.apache.axis2.AxisFault {
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, gr.uoc.imse.wineprows.ListAllWinesInBetweenResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, gr.uoc.imse.wineprows.WarehouseInventoryCheckResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(gr.uoc.imse.wineprows.WarehouseInventoryCheckResponse.MY_QNAME,factory));
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse.MY_QNAME,factory));
                        ...
                        throw org.apache.axis2.AxisFault.makeFault(e);
                         ...
                         private gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse wrapgetTotalWeightVolume(){
                                gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse wrappedElement = new gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse();
                                return wrappedElement;
                         }
                    
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, gr.uoc.imse.wineprows.WarehouseInventoryReserveResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(gr.uoc.imse.wineprows.WarehouseInventoryReserveResponse.MY_QNAME,factory));
                        ...
                        throw org.apache.axis2.AxisFault.makeFault(e);
                         ...
                         private gr.uoc.imse.wineprows.WarehouseInventoryReserveResponse wrapwarehouseInventoryReserve(){
                                gr.uoc.imse.wineprows.WarehouseInventoryReserveResponse wrappedElement = new gr.uoc.imse.wineprows.WarehouseInventoryReserveResponse();
                                return wrappedElement;
                         }
                    
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, gr.uoc.imse.wineprows.GetTotalPriceOfGoodsResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        ...
        */
        ...
        try {
                ...
                if (gr.uoc.imse.wineprows.GetTotalWeightVolume.class.equals(type)){
                
                           return gr.uoc.imse.wineprows.GetTotalWeightVolume.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse.class.equals(type)){
                
                           return gr.uoc.imse.wineprows.GetTotalWeightVolumeResponse.Factory.parse(param.getXMLStreamReaderWithoutCaching());
