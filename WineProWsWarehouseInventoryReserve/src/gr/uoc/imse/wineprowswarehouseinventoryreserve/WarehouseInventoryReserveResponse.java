...
/**
 * WarehouseInventoryReserveResponse.java
 *
 ...
 */
            ...
            /**
            *  WarehouseInventoryReserveResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class WarehouseInventoryReserveResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://imse.uoc.gr/WineProWsWarehouseInventoryReserve/",
                "warehouseInventoryReserveResponse",
                "ns4");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":warehouseInventoryReserveResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "warehouseInventoryReserveResponse",
    ...
    public static class Factory{
        ...
        */
        public static WarehouseInventoryReserveResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WarehouseInventoryReserveResponse object =
                new WarehouseInventoryReserveResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"warehouseInventoryReserveResponse".equals(type)){
                                ...
                                return (WarehouseInventoryReserveResponse)gr.uoc.imse.wineprowswarehouseinventoryreserve.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
