...
public class WineProWsWineListSkeleton
{
	...
	public gr.uoc.imse.wineprowswinelist.ListAllWinesResponse listAllWines ( gr.uoc.imse.wineprowswinelist.ListAllWines listAllWines )
	{
		...
		throw new java.lang.UnsupportedOperationException( "Please implement " + this.getClass().getName() + "#listAllWines" );
	}
	...
	{
		// TODO : fill this with the necessary business logic
		throw new java.lang.UnsupportedOperationException( "Please implement " + this.getClass().getName() + "#listAllWinesInBetween" );
	}
