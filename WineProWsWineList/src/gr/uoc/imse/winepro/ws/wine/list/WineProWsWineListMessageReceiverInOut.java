...
/**
 * WineProWsWineListMessageReceiverInOut.java
 *
        ...
        */
            ...
            if("listAllWines".equals(methodName)){
                ...
                gr.uoc.imse.wineprowswinelist.ListAllWinesResponse listAllWinesResponse1 = null;
	                        gr.uoc.imse.wineprowswinelist.ListAllWines wrappedParam =
                                                             (gr.uoc.imse.wineprowswinelist.ListAllWines)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    gr.uoc.imse.wineprowswinelist.ListAllWines.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), listAllWinesResponse1, false, new javax.xml.namespace.QName("http://imse.uoc.gr/WineProWsWineList/",
                                                    "listAllWines"));
                                    } else 
            ...
            if("listAllWinesInBetween".equals(methodName)){
                ...
                gr.uoc.imse.wineprowswinelist.ListAllWinesInBetweenResponse listAllWinesInBetweenResponse3 = null;
	                        gr.uoc.imse.wineprowswinelist.ListAllWinesInBetween wrappedParam =
                                                             (gr.uoc.imse.wineprowswinelist.ListAllWinesInBetween)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    gr.uoc.imse.wineprowswinelist.ListAllWinesInBetween.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), listAllWinesInBetweenResponse3, false, new javax.xml.namespace.QName("http://imse.uoc.gr/WineProWsWineList/",
        ...
        //
            ...
            throws org.apache.axis2.AxisFault {
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, gr.uoc.imse.wineprowswinelist.ListAllWinesResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                    ...
                    private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, gr.uoc.imse.wineprowswinelist.ListAllWinesInBetweenResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                        throws org.apache.axis2.AxisFault{
                      try{
                          org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
                           
                                    emptyEnvelope.getBody().addChild(param.getOMElement(gr.uoc.imse.wineprowswinelist.ListAllWinesInBetweenResponse.MY_QNAME,factory));
                        ...
                        throw org.apache.axis2.AxisFault.makeFault(e);
                         ...
                         private gr.uoc.imse.wineprowswinelist.ListAllWinesInBetweenResponse wraplistAllWinesInBetween(){
                                gr.uoc.imse.wineprowswinelist.ListAllWinesInBetweenResponse wrappedElement = new gr.uoc.imse.wineprowswinelist.ListAllWinesInBetweenResponse();
                                return wrappedElement;
                         }
