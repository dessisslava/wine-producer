/**
 * WineType.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.6.2 Built on : Apr 17, 2012 (05:34:40 IST)
 */
...
public class WineType implements org.apache.axis2.databinding.ADBBean
{
	/*
	 ...
	 * 
	 * @param param
	 *        gr.uoc.imse.winelistrequestor.WineTypeSequence
	 */
	public void addWineTypeSequence ( gr.uoc.imse.winelistrequestor.WineTypeSequence param )
	{
		...
		this.localWineTypeSequence =
				(gr.uoc.imse.winelistrequestor.WineTypeSequence[]) list.toArray( new gr.uoc.imse.winelistrequestor.WineTypeSequence [ list
					.size() ] );
			...
			try
			{
				...
				if ( reader.getAttributeValue( "http://www.w3.org/2001/XMLSchema-instance", "type" ) != null )
				{
					...
					if ( fullTypeName != null )
					{
						...
						if ( !"WineType".equals( type ) )
						{
							...
							return (WineType) gr.uoc.imse.wineprowswinelist.ExtensionMapper.getTypeObject( nsUri, type, reader );
						}
				...
				try
				{
					...
					if ( reader.isStartElement() )
					{
						...
						object
							.setWineTypeSequence( (gr.uoc.imse.winelistrequestor.WineTypeSequence[]) org.apache.axis2.databinding.utils.ConverterUtil
								.convertToArray( gr.uoc.imse.winelistrequestor.WineTypeSequence.class, list1 ) );
