 ...
 */
            ...
            /**
            *  GetTransportationCost bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTransportationCost
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getTransportationCost",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getTransportationCost",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localUrgentDelivery));
    ...
    public static class Factory{
        ...
        */
        public static GetTransportationCost parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTransportationCost object =
                new GetTransportationCost();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTransportationCost".equals(type)){
                                ...
                                return (GetTransportationCost)gr.uoc.imse.transportationb.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
