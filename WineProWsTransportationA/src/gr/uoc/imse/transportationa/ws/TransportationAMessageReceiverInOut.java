/**
 * TransportationAMessageReceiverInOut.java This file was auto-generated from WSDL by the Apache Axis2 version: 1.6.2 Built on : Apr 17,
 * 2012 (05:33:49 IST)
 */
...
public class TransportationAMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver
{
				...
				&& ( ( methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier( op.getName().getLocalPart() ) ) != null ) )
			{
				...
				if ( "checkStatusOfDelivery".equals( methodName ) )
				{
					...
					gr.uoc.imse.transportationa.CheckStatusOfDelivery wrappedParam =
							(gr.uoc.imse.transportationa.CheckStatusOfDelivery) fromOM( msgContext.getEnvelope().getBody()
								.getFirstElement(), gr.uoc.imse.transportationa.CheckStatusOfDelivery.class,
					...
					envelope =
							toEnvelope( getSOAPFactory( msgContext ), checkStatusOfDeliveryResponse1, false, new javax.xml.namespace.QName(
								"http://imse.uoc.gr/transportationA/", "checkStatusOfDelivery" ) );
				}
				else
				...
				if ( "getTransportationCost".equals( methodName ) )
				{
					...
					gr.uoc.imse.transportationa.GetTransportationCost wrappedParam =
							(gr.uoc.imse.transportationa.GetTransportationCost) fromOM( msgContext.getEnvelope().getBody()
								.getFirstElement(), gr.uoc.imse.transportationa.GetTransportationCost.class,
								getEnvelopeNamespaces( msgContext.getEnvelope() ) );
					...
					envelope =
							toEnvelope( getSOAPFactory( msgContext ), getTransportationCostResponse3, false, new javax.xml.namespace.QName(
								"http://imse.uoc.gr/transportationA/", "getTransportationCost" ) );
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope ( org.apache.axiom.soap.SOAPFactory factory,
			gr.uoc.imse.transportationa.CheckStatusOfDeliveryResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName )
			throws org.apache.axis2.AxisFault
	{
		try
		{
			...
			emptyEnvelope.getBody().addChild(
				param.getOMElement( gr.uoc.imse.transportationa.CheckStatusOfDeliveryResponse.MY_QNAME, factory ) );
	...
	{
		gr.uoc.imse.transportationa.CheckStatusOfDeliveryResponse wrappedElement =
				new gr.uoc.imse.transportationa.CheckStatusOfDeliveryResponse();
		return wrappedElement;
	}

	private org.apache.axiom.soap.SOAPEnvelope toEnvelope ( org.apache.axiom.soap.SOAPFactory factory,
			gr.uoc.imse.transportationa.GetTransportationCostResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName )
			throws org.apache.axis2.AxisFault
	{
		try
		{
			...
			emptyEnvelope.getBody().addChild(
				param.getOMElement( gr.uoc.imse.transportationa.GetTransportationCostResponse.MY_QNAME, factory ) );
	...
	{
		gr.uoc.imse.transportationa.GetTransportationCostResponse wrappedElement =
				new gr.uoc.imse.transportationa.GetTransportationCostResponse();
		return wrappedElement;
	}
